...
[MeanColumn]
[MemoryDiagnoser]
public class OrderBy_AggregateBenchmarks {
    TestData[] testData = { };
    ...
    public string Standard_() => Standard.OrderBy_Aggregate(testData);

    [Benchmark]
    public string Meta_() => Meta.OrderBy_Aggregate(testData);
}
