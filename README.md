...
|    Method |    N |        Mean |      Error |    StdDev | Ratio | RatioSD |  Gen 0 |  Gen 1 | Allocated |
|---------- |----- |------------:|-----------:|----------:|------:|--------:|-------:|-------:|----------:|
| Standard_ |   10 |    85.54 ns |   1.021 ns |  0.675 ns |  1.00 |    0.00 | 0.0421 |      - |     264 B |
|     Meta_ |   10 |    48.43 ns |   1.316 ns |  0.688 ns |  0.57 |    0.01 | 0.0344 |      - |     216 B |
|           |      |             |            |           |       |         |        |        |           |
| Standard_ |  100 |   698.35 ns |  11.896 ns |  7.869 ns |  1.00 |    0.00 | 0.3386 | 0.0010 |   2,128 B |
|     Meta_ |  100 |   552.06 ns |  22.875 ns | 15.131 ns |  0.79 |    0.02 | 0.3309 | 0.0010 |   2,080 B |
|           |      |             |            |           |       |         |        |        |           |
| Standard_ | 1000 | 6,301.56 ns | 140.519 ns | 92.945 ns |  1.00 |    0.00 | 3.5553 | 0.1678 |  22,360 B |
|     Meta_ | 1000 | 5,224.18 ns |  79.048 ns | 41.344 ns |  0.83 |    0.01 | 3.5477 | 0.1984 |  22,312 B |

## Select_ToDictionary

|    Method |    N |        Mean |     Error |    StdDev | Ratio | RatioSD |   Gen 0 |  Gen 1 | Allocated |
|---------- |----- |------------:|----------:|----------:|------:|--------:|--------:|-------:|----------:|
| Standard_ |   10 |    285.2 ns |   6.59 ns |   3.92 ns |  1.00 |    0.00 |  0.1287 |      - |     808 B |
|     Meta_ |   10 |    103.6 ns |   1.17 ns |   0.70 ns |  0.36 |    0.01 |  0.0701 |      - |     440 B |
|           |      |             |           |           |       |         |         |        |           |
| Standard_ |  100 |  2,537.5 ns | 234.35 ns | 155.01 ns |  1.00 |    0.00 |  1.1826 | 0.0191 |   7,424 B |
|     Meta_ |  100 |    947.5 ns |  22.47 ns |  14.86 ns |  0.37 |    0.02 |  0.4978 | 0.0057 |   3,128 B |
|           |      |             |           |           |       |         |         |        |           |
| Standard_ | 1000 | 28,204.1 ns | 687.34 ns | 454.63 ns |  1.00 |    0.00 | 11.6272 | 1.9226 |  73,200 B |
|     Meta_ | 1000 |  9,291.8 ns | 226.25 ns | 149.65 ns |  0.33 |    0.01 |  4.9133 | 0.4883 |  31,016 B |
