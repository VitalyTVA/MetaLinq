...
## OrderBy_AnyBenchmarks

|    Method |    N |         Mean |        Error |       StdDev |       Median | Ratio |  Gen 0 | Allocated |
|---------- |----- |-------------:|-------------:|-------------:|-------------:|------:|-------:|----------:|
| Standard_ |   10 |    315.11 ns |     8.879 ns |     5.873 ns |    316.09 ns |  1.00 | 0.0892 |     560 B |
|     Meta_ |   10 |     12.34 ns |     0.928 ns |     0.614 ns |     12.32 ns |  0.04 | 0.0140 |      88 B |
|           |      |              |              |              |              |       |        |           |
| Standard_ |  100 |  3,945.87 ns |   210.953 ns |   125.535 ns |  3,916.23 ns | 1.000 | 0.3128 |   2,000 B |
|     Meta_ |  100 |     18.64 ns |    12.920 ns |     8.545 ns |     14.06 ns | 0.004 | 0.0140 |      88 B |
|           |      |              |              |              |              |       |        |           |
| Standard_ | 1000 | 90,321.00 ns | 7,106.165 ns | 4,700.288 ns | 89,413.04 ns | 1.000 | 2.5635 |  16,400 B |
|     Meta_ | 1000 |     11.66 ns |     0.375 ns |     0.248 ns |     11.61 ns | 0.000 | 0.0140 |      88 B |

## OrderBy_SingleBenchmarks

|    Method |    N |         Mean |      Error |     StdDev | Ratio |  Gen 0 |  Gen 1 | Allocated |
|---------- |----- |-------------:|-----------:|-----------:|------:|-------:|-------:|----------:|
| Standard_ |   10 |    247.53 ns |   6.073 ns |   3.176 ns |  1.00 | 0.0749 |      - |     472 B |
|     Meta_ |   10 |     20.03 ns |   1.182 ns |   0.782 ns |  0.08 |      - |      - |         - |
|           |      |              |            |            |       |        |        |           |
| Standard_ |  100 |  3,018.95 ns |  78.816 ns |  46.902 ns |  1.00 | 0.3014 |      - |   1,912 B |
|     Meta_ |  100 |    159.18 ns |   3.997 ns |   2.379 ns |  0.05 |      - |      - |         - |
|           |      |              |            |            |       |        |        |           |
| Standard_ | 1000 | 34,972.33 ns | 586.330 ns | 348.915 ns |  1.00 | 2.5635 | 0.0610 |  16,312 B |
|     Meta_ | 1000 |  1,449.01 ns |  40.592 ns |  24.156 ns |  0.04 |      - |      - |         - |

## OrderBy_AggregateBenchmarks

|    Method |    N |        Mean |       Error |    StdDev | Ratio |  Gen 0 |  Gen 1 | Allocated |
|---------- |----- |------------:|------------:|----------:|------:|-------:|-------:|----------:|
| Standard_ |   10 |    389.1 ns |     2.86 ns |   1.70 ns |  1.00 | 0.0992 |      - |     624 B |
|     Meta_ |   10 |    158.7 ns |     3.61 ns |   2.38 ns |  0.41 | 0.0343 |      - |     216 B |
|           |      |             |             |           |       |        |        |           |
| Standard_ |  100 |  4,694.9 ns |    44.64 ns |  26.56 ns |  1.00 | 0.5264 |      - |   3,328 B |
|     Meta_ |  100 |  1,990.6 ns |    52.46 ns |  34.70 ns |  0.42 | 0.2899 |      - |   1,840 B |
|           |      |             |             |           |       |        |        |           |
...
|    Method |     N |        Mean |       Error |    StdDev | Ratio | RatioSD |  Gen 0 | Allocated |
|---------- |------ |------------:|------------:|----------:|------:|--------:|-------:|----------:|
| Standard_ |   100 |    620.3 ns |   190.42 ns | 125.95 ns |  1.00 |    0.00 | 0.0076 |      48 B |
|     Meta_ |   100 |    254.4 ns |     4.89 ns |   3.23 ns |  0.42 |    0.08 |      - |         - |
|           |       |             |             |           |       |         |        |           |
| Standard_ | 10000 | 47,350.7 ns | 1,398.71 ns | 925.16 ns |  1.00 |    0.00 |      - |      48 B |
|     Meta_ | 10000 | 25,652.8 ns |   643.18 ns | 425.42 ns |  0.54 |    0.01 |      - |         - |

## Select_MinN

|    Method |     N |        Mean |       Error |      StdDev | Ratio | RatioSD |  Gen 0 | Allocated |
|---------- |------ |------------:|------------:|------------:|------:|--------:|-------:|----------:|
| Standard_ |   100 |    600.8 ns |    29.57 ns |    17.60 ns |  1.00 |    0.00 | 0.0076 |      48 B |
|     Meta_ |   100 |    364.6 ns |     7.23 ns |     4.78 ns |  0.61 |    0.02 |      - |         - |
|           |       |             |             |             |       |         |        |           |
| Standard_ | 10000 | 96,318.3 ns | 3,172.35 ns | 2,098.32 ns |  1.00 |    0.00 |      - |      48 B |
|     Meta_ | 10000 | 61,646.8 ns | 1,619.57 ns | 1,071.24 ns |  0.64 |    0.02 |      - |         - |