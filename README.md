...
|----------------- |------ |---------------:|-------------:|------------:|------:|--------:|---------:|---------:|---------:|----------:|
| OrderBy_Standard |    10 |       271.5 ns |      3.60 ns |     2.38 ns |  1.00 |    0.00 |   0.0815 |        - |        - |     512 B |
|     OrderBy_Meta |    10 |       139.1 ns |      5.52 ns |     3.65 ns |  0.51 |    0.01 |   0.0267 |        - |        - |     168 B |
|       OrderBy_AF |    10 |       661.9 ns |      3.80 ns |     2.26 ns |  2.44 |    0.03 |   0.1411 |        - |        - |     888 B |
|                  |       |                |              |             |       |         |          |          |          |           |
| OrderBy_Standard |   100 |     3,566.0 ns |     92.26 ns |    61.03 ns |  1.00 |    0.00 |   0.4234 |        - |        - |   2,672 B |
|     OrderBy_Meta |   100 |     1,477.0 ns |     49.26 ns |    32.58 ns |  0.41 |    0.01 |   0.1984 |        - |        - |   1,248 B |
|       OrderBy_AF |   100 |     7,248.6 ns |    122.46 ns |    81.00 ns |  2.03 |    0.04 |   1.1444 |   0.0076 |        - |   7,216 B |
|                  |       |                |              |             |       |         |          |          |          |           |
| OrderBy_Standard |  1000 |    74,329.2 ns |    772.21 ns |   510.77 ns |  1.00 |    0.00 |   3.7842 |   0.2441 |        - |  24,272 B |
|     OrderBy_Meta |  1000 |    28,460.1 ns |  4,137.99 ns | 2,737.02 ns |  0.38 |    0.04 |   1.8921 |   0.0610 |        - |  12,048 B |
|       OrderBy_AF |  1000 |   117,589.0 ns |  1,722.99 ns | 1,025.32 ns |  1.58 |    0.02 |   9.1553 |   0.4883 |        - |  58,000 B |
|                  |       |                |              |             |       |         |          |          |          |           |
| OrderBy_Standard | 10000 | 1,095,649.8 ns | 10,984.58 ns | 7,265.62 ns |  1.00 |    0.00 |  37.1094 |   9.7656 |        - | 240,273 B |
|     OrderBy_Meta | 10000 |   614,622.8 ns |  5,478.07 ns | 3,259.91 ns |  0.56 |    0.00 |  18.5547 |   3.9063 |        - | 120,049 B |
|       OrderBy_AF | 10000 | 1,670,798.8 ns | 11,454.44 ns | 6,816.36 ns |  1.52 |    0.01 | 132.8125 | 132.8125 | 132.8125 | 769,214 B |
