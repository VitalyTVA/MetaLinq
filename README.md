...
|-------- |------ |-------------:|-----------:|-----------:|------:|----------:|
| Foreach |    10 |     8.182 ns |  0.1395 ns |  0.0830 ns |  1.00 |         - |
|     For |    10 |     6.987 ns |  0.0380 ns |  0.0199 ns |  0.85 |         - |
|         |       |              |            |            |       |           |
| Foreach |   100 |    73.828 ns |  0.8289 ns |  0.5483 ns |  1.00 |         - |
|     For |   100 |    55.172 ns |  0.2336 ns |  0.1222 ns |  0.75 |         - |
|         |       |              |            |            |       |           |
| Foreach |  1000 |   727.961 ns |  7.1377 ns |  4.7211 ns |  1.00 |         - |
|     For |  1000 |   688.787 ns |  4.1434 ns |  2.7406 ns |  0.95 |         - |
|         |       |              |            |            |       |           |
| Foreach | 10000 | 7,245.400 ns | 43.5989 ns | 28.8380 ns |  1.00 |         - |
|     For | 10000 | 6,927.583 ns | 20.0165 ns | 13.2397 ns |  0.96 |         - |
