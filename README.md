...
|   Method |    N |        Mean |      Error |    StdDev | Ratio | RatioSD |  Gen 0 |  Gen 1 | Allocated |
|--------- |----- |------------:|-----------:|----------:|------:|--------:|-------:|-------:|----------:|
| Standard |   10 |    96.20 ns |   1.865 ns |  1.110 ns |  1.00 |    0.00 | 0.0356 |      - |     224 B |
|     Meta |   10 |    60.81 ns |   1.736 ns |  1.148 ns |  0.63 |    0.02 | 0.0280 |      - |     176 B |
|          |      |             |            |           |       |         |        |        |           |
| Standard |  100 |   700.57 ns |   9.317 ns |  5.544 ns |  1.00 |    0.00 | 0.2546 |      - |   1,600 B |
|     Meta |  100 |   568.10 ns |   9.073 ns |  6.001 ns |  0.81 |    0.01 | 0.2470 | 0.0010 |   1,552 B |
|          |      |             |            |           |       |         |        |        |           |
| Standard | 1000 | 7,191.15 ns |  98.317 ns | 65.031 ns |  1.00 |    0.00 | 2.5635 | 0.0839 |  16,096 B |
|     Meta | 1000 | 5,993.29 ns | 102.301 ns | 67.666 ns |  0.83 |    0.01 | 2.5558 | 0.0839 |  16,048 B |

## Select_ToHashSet

|   Method |    N |        Mean |     Error |    StdDev | Ratio | RatioSD |   Gen 0 |  Gen 1 | Allocated |
|--------- |----- |------------:|----------:|----------:|------:|--------:|--------:|-------:|----------:|
| Standard |   10 |    279.0 ns |   2.07 ns |   1.23 ns |  1.00 |    0.00 |  0.1287 |      - |     808 B |
|     Meta |   10 |    135.5 ns |   6.57 ns |   4.35 ns |  0.49 |    0.02 |  0.0534 |      - |     336 B |
|          |      |             |           |           |       |         |         |        |           |
| Standard |  100 |  2,295.8 ns |  44.73 ns |  29.59 ns |  1.00 |    0.00 |  1.1826 | 0.0191 |   7,424 B |
|     Meta |  100 |  1,184.0 ns |  30.89 ns |  20.43 ns |  0.52 |    0.01 |  0.3586 | 0.0019 |   2,256 B |
|          |      |             |           |           |       |         |         |        |           |
| Standard | 1000 | 24,796.7 ns | 447.16 ns | 295.77 ns |  1.00 |    0.00 | 11.6272 | 1.9226 |  73,200 B |
|     Meta | 1000 | 12,726.0 ns | 318.15 ns | 210.44 ns |  0.51 |    0.01 |  3.5095 | 0.2594 |  22,176 B |